...
export default function OnlineReputationManagement() {
  ...
  useEffect(() => {
    ...
    const element = document.getElementById("reputation-management-page")
  ...
  const reputationServices = [
    {
      ...
      description:
        "24/7 monitoring of your online presence across search engines, review sites, social media, and news outlets to track brand mentions.",
      color: "from-blue-500 via-indigo-500 to-purple-500",
      shadowColor: "shadow-blue-500/25",
      features: ["Real-time Alerts", "Multi-platform Tracking", "Sentiment Analysis"],
      details:
        "Advanced monitoring tools track mentions across Google, Bing, social platforms, review sites, forums, and news outlets in real-time.",
      stats: "1M+ Sources Monitored",
    },
    {
      icon: "⭐",
      title: "Review Management",
      description:
        "Comprehensive review management across Google, Yelp, Facebook, and industry-specific platforms to build positive online reputation.",
      color: "from-emerald-500 via-teal-500 to-cyan-500",
      shadowColor: "shadow-emerald-500/25",
      features: ["Review Response", "Rating Improvement", "Review Generation"],
      details:
        "Strategic review management that encourages positive reviews, addresses negative feedback professionally, and improves overall ratings.",
    ...
    },
    {
      ...
      description:
        "Rapid response crisis management to address negative publicity, viral content, and reputation threats before they escalate.",
      color: "from-red-500 via-rose-500 to-pink-500",
      shadowColor: "shadow-red-500/25",
      features: ["24/7 Response", "Crisis Planning", "Damage Control"],
      details:
        "Immediate crisis response protocols with PR strategies, content removal, and reputation recovery plans to minimize damage.",
    ...
    },
    {
      ...
      description:
        "Proactive brand protection services including trademark monitoring, fake profile detection, and unauthorized content removal.",
      color: "from-orange-500 via-amber-500 to-yellow-500",
      shadowColor: "shadow-orange-500/25",
      features: ["Trademark Protection", "Fake Profile Removal", "Content Takedowns"],
      details:
        "Comprehensive brand protection against impersonation, trademark infringement, and unauthorized use of brand assets online.",
      stats: "99% Threat Prevention",
    },
    {
      icon: "🔧",
      title: "SEO Reputation Repair",
      description:
        "Strategic SEO techniques to suppress negative content and promote positive search results for your brand and key personnel.",
      color: "from-violet-500 via-purple-500 to-fuchsia-500",
      shadowColor: "shadow-violet-500/25",
      features: ["Search Suppression", "Positive Content Creation", "SERP Optimization"],
      details:
        "Advanced SEO strategies to push down negative content and elevate positive brand content in search engine results.",
      stats: "Page 1 Domination",
    },
    {
      icon: "📱",
      title: "Social Media Reputation",
      description:
        "Social media reputation management including content moderation, community management, and positive engagement strategies.",
      color: "from-pink-500 via-rose-500 to-red-500",
      shadowColor: "shadow-pink-500/25",
      features: ["Content Moderation", "Community Building", "Engagement Strategy"],
      details:
        "Comprehensive social media reputation management across all platforms with proactive community building and crisis prevention.",
  ...
  const benefits = [
    {
      ...
      description: "Build unshakeable trust with customers and stakeholders",
      percentage: "400%",
    ...
    },
    {
      ...
      description: "Positive reputation drives more customers and revenue",
      percentage: "350%",
    ...
    },
    {
      ...
      description: "Proactive monitoring prevents reputation disasters",
      percentage: "90%",
    ...
    },
    {
      ...
      description: "Lightning-fast response to reputation threats",
      percentage: "2hrs",
  ...
  return (
    <div id="reputation-management-page" className="min-h-screen bg-white relative overflow-hidden">
      ...
      <FloatingElement
        delay="0"
        duration="8"
        className="top-20 right-20 w-96 h-96 bg-gradient-to-r from-blue-400/20 to-indigo-400/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse-rainbow"
      >
        <div></div>
      </FloatingElement>
      <FloatingElement
        delay="3"
        duration="10"
        className="bottom-20 left-20 w-80 h-80 bg-gradient-to-r from-emerald-400/20 to-teal-400/20 rounded-full mix-blend-multiply filter blur-3xl animate-pulse-rainbow"
      >
        <div></div>
      </FloatingElement>
      <FloatingElement
      ...
      <section className="py-24 px-10 relative z-10">
        <div className="container mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center bg-gradient-to-r from-blue-500/10 via-indigo-500/10 to-purple-500/10 border border-blue-500/20 rounded-full px-6 py-3 mb-8 backdrop-blur-sm hover:scale-105 transition-transform duration-300 animate-wiggle">
              <span className="text-sm font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                🛡️ Online Reputation Management Excellence
              </span>
            </div>
            ...
            <div className="max-w-6xl mx-auto mb-8">
              <p className="text-xl text-gray-600 mb-6 leading-relaxed font-light">
                <strong className="text-gray-900">Online Reputation Management</strong> is the practice of monitoring,
                influencing, and managing your brand's digital footprint across the internet. It involves tracking
                mentions, managing reviews, addressing negative content, and building a positive online presence that
                reflects your brand's true value and builds customer trust.
              </p>
              <p className="text-2xl text-gray-700 leading-relaxed font-light">
                Safeguard your brand's reputation with comprehensive monitoring, crisis management, and strategic
                reputation building that turns your online presence into a competitive advantage.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button className="group relative bg-gradient-to-r from-blue-500 to-purple-500 text-white px-10 py-5 rounded-2xl font-bold text-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 overflow-hidden hover:scale-105">
                <span className="relative z-10">Get Free Reputation Audit</span>
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 to-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
              </button>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light">
              Comprehensive reputation management solutions to protect and enhance your digital presence
            </p>
          </div>
      ...
      <section className="py-24 px-10 bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 relative z-10">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            <h2 className="text-5xl lg:text-6xl font-black text-gray-900 mb-8">
              Why Choose Our{" "}
            ...
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-light">
              Experience the power of professional reputation management that protects and enhances your brand
            </p>
          </div>
      ...
      <section className="py-24 px-10 relative z-10">
        <div className="container mx-auto px-6">
          <div className="relative text-center bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-500 rounded-3xl p-20 text-white overflow-hidden animate-rainbow">
            {/* Background Pattern */}
            ...
            <div className="relative z-10">
              <h2 className="text-5xl lg:text-6xl font-black mb-8 leading-tight">Ready to Protect Your Brand?</h2>
              <p className="text-2xl mb-12 opacity-90 max-w-3xl mx-auto font-light leading-relaxed">
                Let's safeguard your digital reputation with comprehensive monitoring, crisis management, and strategic
                reputation building that turns your online presence into a competitive advantage.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
