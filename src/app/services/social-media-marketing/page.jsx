...
export default function SocialMediaMarketing() {
  ...
  useEffect(() => {
    ...
    const element = document.getElementById("social-media-page")
  ...
  const socialMediaServices = [
    {
      ...
      description:
        "Develop comprehensive social media strategies that align with your business goals and target audience across all major platforms.",
      color: "from-pink-500 via-rose-500 to-red-500",
      shadowColor: "shadow-pink-500/25",
      features: ["Platform Selection", "Content Calendar", "Audience Analysis"],
      details:
        "We create data-driven strategies that maximize engagement and drive conversions across Facebook, Instagram, Twitter, LinkedIn, and TikTok.",
      stats: "500% Engagement Boost",
    },
    {
      icon: "🎨",
      title: "Content Creation",
      description:
        "Create engaging, high-quality content that resonates with your audience and drives meaningful interactions across social platforms.",
      color: "from-purple-500 via-violet-500 to-indigo-500",
      shadowColor: "shadow-purple-500/25",
      features: ["Visual Design", "Video Content", "Copywriting"],
      details:
        "From eye-catching graphics to viral videos, we produce content that stops the scroll and converts viewers into customers.",
      stats: "1M+ Content Views",
    },
    {
      icon: "📊",
      title: "Social Media Advertising",
      description:
        "Run targeted ad campaigns that reach your ideal customers and deliver measurable results with optimized ROI.",
      color: "from-orange-500 via-amber-500 to-yellow-500",
      shadowColor: "shadow-orange-500/25",
      features: ["Targeted Ads", "A/B Testing", "Campaign Optimization"],
      details:
        "Strategic paid social campaigns across Facebook, Instagram, LinkedIn, and Twitter that drive traffic, leads, and sales.",
      stats: "400% ROAS Achieved",
    },
    {
      icon: "💬",
      title: "Community Management",
      description:
        "Build and nurture engaged communities around your brand with responsive customer service and authentic interactions.",
      color: "from-emerald-500 via-teal-500 to-cyan-500",
      shadowColor: "shadow-emerald-500/25",
      features: ["24/7 Monitoring", "Customer Support", "Engagement"],
      details:
        "We manage your social presence, respond to comments, and foster meaningful relationships with your audience.",
    ...
    },
    {
      ...
      description:
        "Track performance metrics and gain actionable insights to continuously improve your social media presence and ROI.",
      color: "from-blue-500 via-sky-500 to-cyan-500",
      shadowColor: "shadow-blue-500/25",
      features: ["Performance Tracking", "ROI Analysis", "Growth Metrics"],
      details:
        "Comprehensive reporting with key metrics, insights, and recommendations to optimize your social media strategy.",
    ...
    },
    {
      ...
      description:
        "Connect with relevant influencers and brand ambassadors to expand your reach and build authentic brand advocacy.",
      ...
      details:
        "Strategic partnerships with micro and macro influencers to amplify your brand message and reach new audiences.",
      stats: "10M+ Reach Generated",
    },
  ]
  ...
  const benefits = [
    {
      ...
      description: "Expand your reach and build brand recognition",
      percentage: "300%",
    ...
    },
    {
      ...
      description: "Build active communities that interact with your brand",
      percentage: "500%",
    ...
    },
    {
      ...
      description: "Dominate all major social media platforms",
      percentage: "8+",
          ...
          <div className="relative text-center bg-gradient-to-r from-pink-500 via-purple-600 to-orange-500 rounded-3xl p-20 text-white overflow-hidden animate-rainbow">
            ...
            <div className="relative z-10">
              ...
              <p className="text-2xl mb-12 opacity-90 max-w-3xl mx-auto font-light leading-relaxed">
                Let's transform your social media presence into a powerful marketing machine that drives engagement,
                builds communities, and converts followers into customers.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
